                                        ...
                                        <div class="">
                                            <table style="width:100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control required"
                                                            id="emailAddress5" name="obyek_pertanggungan"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control required"
                                                            id="emailAddress5" name="harga_pertanggungan"
                                                            value="<?php echo $form_polis['harga_pertanggungan'] ?>">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 mt-2"  align="right">
                                                    ...
                                                    <a href="form-preview-polis.php?id=<?php echo $form_polis['id'];?>">
                                                        <button type="submit" name="approved"
                                                            class="btn btn-success mb-1" style="width:30%"> <i
                                                                class="icon-eye">
                                                                Preview Polis</i>
                                                        </button>
                                                    </a>
                                                ...
                                                <div class="col-md-4 mt-2">
                                                    ...
                                                    <input type="text" class="form-control required"
                                                        ...
                                                        disabled>
                                                    <br>
                                                    <form action="form_pembayaran_polis.php" method="post">
                                                        <input type="text" name="pembayaran_polis"
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-4" align="right">
                                                                ...
                                                                <input type="submit" class="btn btn-primary mr-1 mb-1"
                                                                    name="update" value="Bayar" style="width:100%">
                                                                </input>
                                                    </form>
                                                </div>
                                                <div class="col-md-4">
