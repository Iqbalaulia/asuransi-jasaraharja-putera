                  ...
                  <div class="card-body">
                    <form action="form_edit_customer.php" class="steps-validation wizard-notification" method="POST">
                      ...
                      <?php while($form_customer = mysqli_fetch_array($result)) {
                                ...
                                $provinsi         = $form_customer['provinsi'];
                                $kabkot         = $form_customer['kabkot'];
                                $alamat_bangunan   = $form_customer['alamat_bangunan'];
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <select class="form-control" name="provinsi" id="provinsi"><?php echo $provinsi ?></select>
                            </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <select class="form-control" name="kabkot" id="kabupaten"><?php echo $kabkot ?></select>
                            </div>
                          </div>
                          ...
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              <textarea type="text" class="form-control required" id="lastName3" rows="5"
                                name="alamat_bangunan" placeholder="Alamat bangunan"><?php echo $alamat_bangunan ?></textarea>
                            </div>
                          </div>
                        </div>
                        <div class="row">
                              ...
                              <table style="width:100%;">
                                ...
                                <tr>
                                  ...
                                  <td> <input type="number" class="form-control required" id="emailAddress5"
                                      name="nilai_bangungan" placeholder="Nilai bangunan"
                                      value="<?php echo $nilai_bangunan ?>"></td>

                                </tr>
                                <tr>
                                  <td>Mesin - mesin &nbsp;</td>
                                  <td> <input type="number" class="form-control required" id="emailAddress5"
                                      name="nilai_mesin" placeholder="Nilai mesin - mesin"
                                      value="<?php echo $nilai_mesin ?>"></td>
                                </tr>
                                <tr>
                                  <td>Persedian barang - barang &nbsp;</td>
                                  <td> <input type="number" class="form-control required" id="emailAddress5"
                                      name="nilai_barang" placeholder="Nilai barang - barang"
                                      value="<?php echo $nilai_barang ?>"></td>
                                </tr>
                                <tr>
                                  <td>Barang - barang dagangan &nbsp;</td>
                                  <td> <input type="number" class="form-control required" id="emailAddress5"
                                      name="nilai_dagangan" placeholder="Nilai barang dagangan"
                                      value="<?php echo $nilai_dagangan ?>"></td>
                                </tr>
                                <tr>
                                  <td>Perabot rumah tangga &nbsp;</td>
                                  <td> <input type="number" class="form-control required" id="emailAddress5"
                                      name="nilai_perabot_rumah" placeholder="Nilai perabot rumah"
                                      value="<?php echo $nilai_perabot_rumah ?>"></td>
                                </tr>
                                <tr>
                                  <td>Perabot kantor/toko/gudang &nbsp;</td>
                                  <td> <input type="number" class="form-control required" id="emailAddress5"
                                      name="nilai_perabot_kantor" placeholder="Nilai perabot kantor/toko/gudang"
                                      value="<?php echo $nilai_perabot_kantor ?>">
                                  </td>
                                </tr>
                                <tr>
                                  <td>Dan lain lain &nbsp;</td>
                                  <td> <input type="number" class="form-control required" id="emailAddress5"
                                      name="nilai_lain" placeholder="Nilai lain - lain"
                                      value="<?php echo $nilai_lain ?>"></td>
                                </tr>
                                <tr>
                                  <td>Total &nbsp;</td>
                                  <td> <input type="number" class="form-control required" id="emailAddress5"
                                      name="total_keseluruhan" placeholder="Total keseluruhan"
                                      value="<?php echo $total_keseluruhan ?>"></td>
                                </tr>
                              </table>
                              ...
                              <table style="width:100%;">
                                ...
                                <tr>
                                  ...
                                  <td> <input type="text" class="form-control required" id="emailAddress5"
                                      ...
                                      value="<?php echo $ket_dinding_luar ?>"></td>
                                  <td> <input type="text" class="form-control required" id="emailAddress5"
                                      name="ket_dinding_dalam" placeholder="Keterangan dinding dalam"
                                      value="<?php echo $ket_dinding_dalam ?>"></td>
                                  <td> <input type="text" class="form-control required" id="emailAddress5"
                                      name="ket_dinding_pemisah" placeholder="Keterangan dinding pemisah"
                                      value="<?php echo $ket_dinding_pemisah ?>"></td>
                                </tr>
                                <tr>
                                  <td>Lantai &nbsp;</td>
                                  <td> <input type="text" class="form-control required" id="emailAddress5"
                                      name="ket_lantai" placeholder="Keterangan lantai"
                                      value="<?php echo $ket_lantai ?>"></td>
                                </tr>
                                <tr>
                                  <td>Balok &nbsp;</td>
                                  <td> <input type="text" class="form-control required" id="emailAddress5"
                                      name="ket_balok" placeholder="Keterangan balok" value="<?php echo $ket_balok ?>">
                                  </td>
                                </tr>
                                <tr>
                                  <td>Balok lantai &nbsp;</td>
                                  <td> <input type="text" class="form-control required" id="emailAddress5"
                                      ...
                                      value="<?php echo $ket_balok_lantai ?>"></td>
                                </tr>
                                <tr>
                                  <td>Pilar &nbsp;</td>
                                  <td> <input type="text" class="form-control required" id="emailAddress5"
                                      name="ket_pilar" placeholder="Keterangan pilar" value="<?php echo $ket_pilar ?>">
                                  </td>
                                </tr>
                                <tr>
                                  <td>Tiang &nbsp;</td>
                                  <td> <input type="text" class="form-control required" id="emailAddress5"
                                      name="ket_tiang" placeholder="Keterangan tiang" value="<?php echo $ket_tiang ?>">
                                  </td>
                                </tr>
                                <tr>
                                  <td>Anak tangga &nbsp;</td>
                                  <td> <input type="text" class="form-control required" id="emailAddress5"
                                      ...
                                      value="<?php echo $ket_antangga ?>"></td>
                                </tr>
                                <tr>
                                  <td>Atap &nbsp;</td>
                                  <td> <input type="text" class="form-control required" id="emailAddress5"
                                      name="ket_atap" placeholder="Keterangan atap" value="<?php echo $ket_atap ?>">
                                  </td>
                                </tr>
                                <tr>
                                  <td>Loteng &nbsp;</td>
                              ...
                              <table style="width:100%;">
                                ...
                                <tr>
                                  ...
                                  <td> <input type="number" class="form-control required" id="emailAddress5"
                                      ...
                                      value="<?php echo $jarak_bangunan_kiri ?>"></td>
                                </tr>
                                <tr>
                                  <td>Sebalah kanan &nbsp;</td>
                                  <td> <input type="number" class="form-control required" id="emailAddress5"
                                      name="jarak_bangunan_kanan" placeholder="Jarak sebalah kanan bangunan"
                                      value="<?php echo $jarak_bangunan_kanan ?>"></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  <td> <input type="number" class="form-control required" id="emailAddress5"
                                      ...
                                      value="<?php echo $jarak_bangunan_depan ?>"></td>
                                </tr>
                              </table>
                            </div>
                          </div>
                            ...
                            <div class="form-group">
                              <table style="width:100%;">
                                ...
                                <tr>
                                  <td>Jalan &nbsp;</td>
                                  <td> <input type="text" class="form-control required" id="emailAddress5"
                                      name="lokasi_harta_benda_jalan" placeholder="Lokasi jalan" value="<?php echo $lokasi_harta_benda_jalan ?>
"></td>
                                ...
                                <tr>
                                  ...
                                  <td> <input type="text" class="form-control required" id="emailAddress5"
                                      ...
                                      value="<?php echo $lokasi_harta_benda_kota ?>"></td>
                                </tr>
                                <tr>
                                  <td>Provinsi &nbsp;</td>
                                  <td> <input type="text" class="form-control required" id="emailAddress5"
                                      name="lokasi_harta_benda_provinsi" placeholder="Lokasi provinsi"
                                      value="<?php echo $lokasi_harta_benda_provinsi ?>"></td>
                                </tr>
                              ...
                              <table style="width:100%;">
                                ...
                                <tr>
                                  ...
                                  <td> <input type="text" class="form-control required" id="emailAddress5"
                                      ...
                                      value="<?php echo $jenis_pemadam ?>"></td>
                                  <td> <input type="number" class="form-control required" id="emailAddress5"
                                      name="jumlah_alat_pemadam" placeholder="Jumlah alat pemadam"
                                      value="<?php echo $jumlah_alat_pemadam ?>"></td>
                                ...
                                <tr>
                                  ...
                                  <td> <input type="text" class="form-control required" id="emailAddress5"
                                      ...
                                      value="<?php echo $jarak_pos_pemadam ?>"></td>
                                </tr>
                              </table>
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <textarea placeholder="jika iya, beri penjalasan" rows="4" class="form-control required"
                                id="eventName3"
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            ...
                            <div class="form-group">
                              ...
                              <br>
                              <input type="text" class="form-control required" id="meetingLocation3"
                                name="nilai_pertanggungan_kerusakan" placeholder="Nilai pertanggungan perluasan jaminan"
                            ...
                            <div class="form-group">
                              <table style="width:100%;">
                                ...
                                <tr>
                                  <td>Biaya polis &nbsp;</td>
                                  <td> <input type="number" class="form-control required" id="emailAddress5"
                                      name="biaya_polis" placeholder="Biaya polis" value="<?php echo $biaya_polis ?>">
                                  </td>
                                </tr>
                                <tr>
                                  <td>Premi dasar &nbsp;</td>
                                  <td> <input type="number" class="form-control required" id="emailAddress5"
                                      name="premi_dasar" placeholder="Premi dasar" value="<?php echo $premi_dasar ?>">
                                  </td>
                                </tr>
                                <tr>
                                  <td>Total bayar &nbsp;</td>
                                  <td> <input type="number" class="form-control required" id="emailAddress5"
                                      ...
                                      value="<?php echo $total_pembayaran ?>"></td>
                                </tr>
