          ...
          <div class="col-12 d-flex align-items-center justify-content-center">
            <div class="col-md-4 col-10 p-0">
              <div class="card-header bg-transparent border-0">
                <h2 class="error-code text-center mb-2">Salah Kamar !</h2>
                <h3 class="text-uppercase text-center">Tolong cek kembali user dan password anda !</h3>
              </div>
              <div class="card-content">
                ...
                <div class="row py-2">
                  <div class="col-12 col-sm-12 col-md-12">
                    <a href="login.php" class="btn btn-primary btn-block"><i class="ft-home"></i> Back to Login</a>
                  </div>
