...
$result = mysqli_query($koneksi, "SELECT id,nama_lengkap,alamat_pemohon,biaya_polis,premi_dasar,total_pembayaran,status_form FROM form_customer");
?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                <a href='form_delete_customer.php?id=<?php echo $form_customer['id'] ?>'>
                                                                    <button type="button"
                                                        ...
                                                        <div class="col-md-2">
                                                                <form action="form_approved_customer.php" >
                                                                    ...
                                                                    <button type="submit" name="approved"
                                                                        class="btn btn-success mr-1 mb-1" hidden> <i
